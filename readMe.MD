...
create a final initial

and commit it with the message initial
...
in master
create a file masternew.txt

```
git add .
git commit -m masternew
```
 
switch to testing branch

to update the content that is changed in master
...
already in testing branch 
we have commits
testing1
testing2

add one more file testing3
...
Replace second and third Pick with squash
